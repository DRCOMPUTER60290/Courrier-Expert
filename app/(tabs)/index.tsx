...
import { FileText, TrendingUp, Calendar, Share2, Mail, CreditCard, Building, CircleAlert as AlertCircle, Heart, Briefcase, Users, FileCheck, User } from 'lucide-react-native';
...
const letterTypes = [
  {
    ...
    description: 'Candidature emploi',
    icon: Briefcase,
    color: '#3b82f6',
  },
  {
  ...
  },
  {
    ...
    description: 'Demande commerciale',
    icon: FileText,
    color: '#10b981',
  },
  {
  ...
  },
  {
    ...
    description: 'Référence professionnelle',
    icon: Users,
    color: '#8b5cf6',
  },
  {
  ...
  },
  {
    ...
    description: 'Démarche officielle',
    icon: Building,
    color: '#64748b',
  },
  {
...
export default function HomeScreen() {
  ...
  const renderStatCard = (title: string, value: string | number, icon: React.ComponentType<any>, gradient: string[]) => (
